...
def test_graph_dynamics_shapes():
    spec = ObservationSpec(dynamic_dim=5, stack_k=1, static_dim=1)
    model = GraphDynamicsModel(state_dim=6, hidden_dim=8, action_dim=4, max_actions=5, observation_spec=spec, edge_dim=3)
